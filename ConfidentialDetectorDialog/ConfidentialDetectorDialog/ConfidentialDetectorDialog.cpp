...
// ConfidentialDetectorDialog.cpp: определяет поведение классов для приложения.
//
...
// CConfidentialDetectorDialogApp

BEGIN_MESSAGE_MAP(CConfidentialDetectorDialogApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CConfidentialDetectorDialogApp

CConfidentialDetectorDialogApp::CConfidentialDetectorDialogApp()
{
...
// Единственный объект CConfidentialDetectorDialogApp

CConfidentialDetectorDialogApp theApp;


// Инициализация CConfidentialDetectorDialogApp

BOOL CConfidentialDetectorDialogApp::InitInstance()
{
	...
	CConfidentialDetectorDialogDlg dlg;
	m_pMainWnd = &dlg;
